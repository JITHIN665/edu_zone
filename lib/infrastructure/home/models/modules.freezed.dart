...
/// @nodoc
@JsonSerializable()
class _$ModulesImpl with DiagnosticableTreeMixin implements _Modules {
  const _$ModulesImpl(
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Modules(id: $id, title: $title, description: $description)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Modules'))
...
abstract class _Modules implements Modules {
  const factory _Modules(
      ...
      @JsonKey(name: 'description') final String? description}) = _$ModulesImpl;
